...
#
# Command: ./config/imagebuilder/imagebuilder23.sh <source:branch>
#          ./config/imagebuilder/imagebuilder23.sh openwrt:21.02.3
#
#======================================== Functions list ========================================
#
...
custom_config_file="${make_path}/config/imagebuilder/config23"
...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        \
        luci luci-base luci-compat luci-i18n-base-en luci-lib-base luci-lib-docker \
        ...
        \
        luci-app-amlogic luci-i18n-amlogic-en \
        \
        ${config_list} \
        "
